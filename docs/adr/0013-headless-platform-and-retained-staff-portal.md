...
- a dedicated `staff-bff` is **required** in R1 of the redesign
- composition will be implemented via the staff-bff service for aggregation and orchestration needs
...
This confirms the `staff-bff` as a mandatory component of the R1 architecture.
...
1. **ADR 0005**
   ...
   - confirms the requirement for a dedicated `staff-bff`
...
- Confirms the `staff-bff` as a required component per R1 implementation (PR #9)
