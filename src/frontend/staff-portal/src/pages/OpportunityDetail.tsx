      ...
      <div className="rounded-lg border border-gray-200 bg-white p-6">
        <form onSubmit={(e) => { void handleSubmit(onSubmit)(e); }} className="space-y-4">
          ...
          <div className="flex justify-end">
            ...
            <div className="rounded-lg border border-gray-200 bg-white p-6 mt-6"><h2 className="mb-4 text-lg font-semibold">Activity</h2><ActivityTimeline entityId={id ?? ""} entityType="Opportunity" /></div>
