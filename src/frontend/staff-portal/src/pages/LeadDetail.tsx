      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          <div className="rounded-lg border border-border bg-white p-6">
            ...
            <div className="rounded-lg border border-gray-200 bg-white p-6 mt-6"><h2 className="mb-4 text-lg font-semibold">Activity</h2><ActivityTimeline entityId={id ?? ""} entityType="Lead" /></div>
