...
public sealed class Account : BaseEntity
{
    ...
    public static Account Create(Guid tenantId, string name, string? industry = null, string? size = null)
    {
    ...
    public void Update(string? name, string? industry, string? size, string? billingAddress)
    {
